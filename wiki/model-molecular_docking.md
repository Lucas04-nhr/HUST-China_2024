...
<center>{% include button.html link="../" text="Back to Model Introduction"  icon="https://static.igem.wiki/teams/5175/static/sf-symbols/arrowshape-turn-up-backward-fill.svg" icon_title="Go Back" icon_id="back"%}</center>
