...
- Homologous recombination of aldA-fucO-PETase-MHETase(vector).
- Transform the plasmid (homologous recombination) to E. coli DH5α and culture overnight.
- Pick bacterial plaque, PCR bacterial fluid, and verify by agarose gel electrophoresis. We failed to connect these fragments.

**July 20th - July 21st**

- Repeat PCRthe plasmids PETase-MHETase and aldA-fucO to obtain linearized target gene fragments and vector fragments.
...
- Transform the plasmid (homologous recombination) into E. coli DH5α and culture overnight.
- Pick bacterial plaque, PCR bacterial fluid, and verify by agarose gel electrophoresis. The plasmid PETase-MHETase-aldA-fucO is successfully validated, and the strain is stored in an 1:1 mixture of double distilled water and glycerol and keep it at -20°C.
...
- Inoculate *E. coli* DH5$\alpha$ with plasmids tphA2A3BA1-pUC57 and pBBR1-CS2 (vector), tphA2A3BA1-pUC57 and tpaK-pBBR1-CS2 (vector), and culture overnight.
- Extract plasmids tphA2A3BA1-pUC57 and tpaK-pBBR1-CS2.

**August 3rd - August 4th**

- Double enzyme digestion of tphA2A3BA1 and pBBR1-CS2, tpaK and pBBR1-CS2.
- Perform double enzyme digestion on the plasmids tphA2A3BA1-pUC57 and tpaK-pBBR1-CS2 (vector). However, we found that the band length obtained by double enzyme digestion of tpaK-pBBR1-CS2 (vector) is too short.

We suspect that the tpaK gene fragment might contain multiple restriction enzyme sites, resulting in an excess of wrong fragments with identical cohesive ends, which ultimately causes most ligation products to be incorrect.

**August 5th**

- Perform PCR on the plasmid tphA2A3BA1-pUC57 to obtain the tphA2A3BA1 gene fragment with new restriction enzyme sites on both ends. Verify by agarose gel electrophoresis and purify the recovered fragments.
...
{% include figure.html image="https://static.igem.wiki/teams/5175/resources/notebook/notebook-04.png" alt="The results of PCR identification for tphA2A3BA1-tpaK" caption="Fig 4. The PCR identification result of pRhamnolipid" %}
...
We believe that the similar lengths of the rhlA-rhlB fragment and the plasmid pUC57 make it difficult to clearly separate bands during electrophoresis, preventing precise purification of the rhlA-rhlB gene fragment.
...
{% include figure.html image="https://static.igem.wiki/teams/5175/resources/notebook/notebook-05.png" alt="The results of PCR identification for rhlA-rhlB and pVLT33" caption="Fig 5. The PCR identification result of rhlA-rhlB and pVLT33" %}
...
We failed to link these fragments. We suspect that the low activity and low amplification efficiency of the pVLT33 (vector) plasmid resulted in low ligation efficiency between pVLT33 and phaZ. We decide to proceed the expression validation of other plasmids first.
...
{% include figure.html image="https://static.igem.wiki/teams/5175/resources/notebook/notebook-06.png" alt="The results of PCR identification for phaZ and pVLT33" caption="Fig 6. The PCR identification result of phaZ and pVLT33" %}
...
- Inoculate *Escherichia coli* DH5$\alpha$ tphA2A3BA1-tpak and *Escherichia coli* DH5$\alpha$ pBBR1-CS2, and culture overnight.
- Extract plasmids tphA2A3BA1-tpak and pBBR1-CS2.

**August 30th - August 31st**

- Perform electroporation to transfer the plasmids tphA2A3BA1-tpak and pBBR1-CS2 into *Pseudomonas putida* KT2440 and culture overnight.
...
- Configure M9 medium with terephthalic acid as the carbon source, then cultivate *Pseudomonas putida* KT2440 tphA2A3BA1-tpak and *Pseudomonas putida* KT2440 pBBR1-CS2. Determine the growth curve of the two kinds of bacterias.

**September 8th**

- Detect the remaining terephthalic acid by HPLC and verify the degradation efficiency of terephthalic acid in *Pseudomonas putida* KT2440 tphA2A3BA1-tpak and *Pseudomonas putida* KT2440 pBBR1-CS2.

## Ramnolipid Detection

**August 28th - August 29th**

- Inoculate *Escherichia coli* DH5$\alpha$ rhlA-rhlB-pVLT33 and *Escherichia coli* DH5$\alpha$ pVLT33, and culture overnight.
- Extract plasmids rhlA-rhlB-pVLT33 and pVLT33.

**August 30th - August 31st**

- Use electroporation to transfer plasmids rhlA-rhlB-pVLT33 and pVLT33 into *Pseudomonas putida* KT2440 and culture overnight.
- Pick bacterial plaque, PCR bacterial fluid, and verify by agarose gel electrophoresis. Both plasmids are verified successfully, and the strain is stored in an 1:1 mixture of double distilled water and glycerol and keep it at -20°C.
...
- Inoculate *Escherichia coli* DH5$\alpha$ with plasmids PETase-MHETase-aldA-fucO, and culture overnight.
- Extract plasmid PETase-MHETase-aldA-fucO.

**September 11th - September 12th**

- Transfer the plasmid PETase-MHETase-aldA-fucO into *Escherichia coli* BL21 and culture overnight.
...
- Prepare M9 medium with ethylene glycol and glycerol as carbon sources, and expand the cultures of *Escherichia coli* BL21 PETase-MHETase-aldA-fucO and *Escherichia coli* BL21 pUC19. Determine the growth curve of the two kinds of bacterias.
